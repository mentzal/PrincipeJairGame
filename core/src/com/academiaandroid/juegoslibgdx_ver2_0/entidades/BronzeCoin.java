...
public class BronzeCoin extends Actor {
    ...
    public BronzeCoin(World world, Texture texture , Vector2 position ) {
        ...
        fixture.setUserData("monedaBronze");
        monedaOro.dispose();

        setSize(PIXELS_IN_METER, PIXELS_IN_METER);


        Texture spriteOro = new Texture(Gdx.files.internal("imagenes/coin_bronze.png"));
